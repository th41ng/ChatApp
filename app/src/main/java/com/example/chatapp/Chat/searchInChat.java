...
public class searchInChat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chat_activity_search_in_chat);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            if (searchResults.isEmpty()) {
                                Toast.makeText(searchInChat.this, "No results found", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(searchInChat.this, "Results found", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(searchInChat.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
