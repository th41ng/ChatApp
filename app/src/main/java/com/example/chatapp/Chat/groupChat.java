...
//
//import com.example.chatapp.ChatUser.UserActivity;
...
//            chatRoomIdBuilder.append(userId.substring(0, Math.min(5, userId.length()))).append("_");
//        }
//        if (chatRoomIdBuilder.length() > 0) {
//            chatRoomIdBuilder.setLength(chatRoomIdBuilder.length() - 1); // Loại bỏ ký tự "_" cuối cùng
//        }
